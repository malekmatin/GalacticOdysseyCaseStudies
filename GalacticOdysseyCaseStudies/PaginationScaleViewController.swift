//
//  PaginationScaleViewController.swift
...
class PaginationScaleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        scaleAnimation.values = [ CGSize(width: 1, height: 1), CGSize(width: 3, height: 3), CGSize(width: 1, height: 1), ]
        scaleAnimation.keyTimes = [0, 0.5, 1]
        scaleAnimation.isRemovedOnCompletion = false
        scaleAnimation.duration = 1
        
        animationGroup.animations = [ motionPathAnimation, scaleAnimation ]
        
        subject.add(animationGroup, forKey: "animations")
        
        subject.translation = .init(x: view.center.x, y: view.center.y - (ArtboardWidth / 2))
    }
}


extension PaginationScaleViewController: UIScrollViewDelegate {
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        subject.translation = .init(x: view.center.x - path_displacement, y: view.center.y - (ArtboardWidth / 2))
